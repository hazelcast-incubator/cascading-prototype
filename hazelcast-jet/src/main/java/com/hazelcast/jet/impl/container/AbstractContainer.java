...
public abstract class AbstractContainer
    ...
    private final List<DataContainer> followers;
    private final List<DataContainer> predecessors;
    ...
    public AbstractContainer(Vertex vertex,
        ...
        this.followers = new ArrayList<DataContainer>();
        this.predecessors = new ArrayList<DataContainer>();
    ...
    @Override
    public List<DataContainer> getFollowers() {
        return followers;
    }

    @Override
    public List<DataContainer> getPredecessors() {
        return predecessors;
    }
    ...
    @Override
    public void addFollower(DataContainer container) {
        this.followers.add(container);
    }

    @Override
    public void addPredecessor(DataContainer container) {
