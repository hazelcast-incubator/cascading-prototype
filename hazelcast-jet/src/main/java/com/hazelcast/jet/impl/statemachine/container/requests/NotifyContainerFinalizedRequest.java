...
public class NotifyContainerFinalizedRequest implements ContainerRequest<DataContainerEvent, DataContainer> {
    private final DataContainer dataContainer;

    public NotifyContainerFinalizedRequest(DataContainer dataContainer) {
        this.dataContainer = dataContainer;
    }

    @Override
    public DataContainerEvent getContainerEvent() {
        return DataContainerEvent.FINALIZE;
    }
