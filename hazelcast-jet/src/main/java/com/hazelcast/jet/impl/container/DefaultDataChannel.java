...
public class DefaultDataChannel implements DataChannel {
    ...
    private final DataContainer sourceContainer;
    private final DataContainer targetContainer;

    public DefaultDataChannel(DataContainer sourceContainer,
                              DataContainer targetContainer,
                              Edge edge) {
        this.edge = edge;
    ...
    @Override
    public DataContainer getTargetContainer() {
