...
public final class JetHazelcastClient {
    private static final HazelcastClientManager HAZELCAST_CLIENT_MANAGER = HazelcastClientManager.HAZELCAST_CLIENT_MANAGER;

    private static final HazelcastClientFactory<JetHazelcastClientInstanceImpl, JetHazelcastClientProxy>
            HAZELCAST_CLIENT_FACTORY =
            new HazelcastClientFactory<JetHazelcastClientInstanceImpl, JetHazelcastClientProxy>() {
                @Override
                public JetHazelcastClientInstanceImpl createHazelcastInstanceClient(ClientConfig config,
