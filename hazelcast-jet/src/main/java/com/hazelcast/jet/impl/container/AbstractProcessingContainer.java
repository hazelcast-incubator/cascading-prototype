...
import com.hazelcast.jet.impl.statemachine.container.processors.TupleContainerPayLoadFactory;
import com.hazelcast.jet.impl.statemachine.container.requests.NotifyContainerFinalizedRequest;
...
public abstract class AbstractProcessingContainer extends
        AbstractContainer<DataContainerEvent, ProcessingContainerState, ProcessingContainerResponse>
    ...
    private static final ProcessingContainerStateMachineFactory STATE_MACHINE_FACTORY =
            new ProcessingContainerStateMachineFactory() {
                @Override
                public ProcessingContainerStateMachine newStateMachine(String name,
    ...
    private void buildTasks() {
        ...
        getApplicationContext().getExecutorContext().getProcessingExecutor().addDistributed(containerTasks);
    }
    ...
    public void processRequest(DataContainerEvent event, Object payLoad) throws Exception {
    ...
    public void destroy() throws Exception {
        ...
        handleContainerRequest(new NotifyContainerFinalizedRequest(this)).get(this.awaitSecondsTimeOut, TimeUnit.SECONDS);
    }
