...
public class ShufflingSender extends AbstractHazelcastWriter {
    ...
    public ShufflingSender(ContainerContext containerContext,
        ...
        this.objectWriterFactory = containerContext.getApplicationContext().getObjectWriterFactory();
    ...
    public boolean isFlushed() {
        return this.ringBufferActor.isFlushed();
    }
    ...
    public void markInterrupted() {
        this.serializer.markInterrupted();
        this.closed = true;
    }
