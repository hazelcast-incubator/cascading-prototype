...
public class InterruptedContainerProcessor implements ContainerPayLoadProcessor<DataContainer> {
    private final ApplicationMaster applicationMaster;

    public InterruptedContainerProcessor(DataContainer container) {
        this.applicationMaster = container.getApplicationContext().getApplicationMaster();
    }

    @Override
    public void process(DataContainer container) throws Exception {
