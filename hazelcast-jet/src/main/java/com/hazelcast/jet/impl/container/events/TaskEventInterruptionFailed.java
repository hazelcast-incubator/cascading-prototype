...
import com.hazelcast.jet.impl.statemachine.applicationmaster.requests.NotifyInterruptionFailedRequest;

public class TaskEventInterruptionFailed extends AbstractEventProcessor {
    protected TaskEventInterruptionFailed(AtomicInteger completedTasks,
    ...
    public void process(ContainerTask containerTask,
        ...
        this.applicationMaster.handleContainerRequest(
                new NotifyInterruptionFailedRequest(this.container)
        );
    }
}
