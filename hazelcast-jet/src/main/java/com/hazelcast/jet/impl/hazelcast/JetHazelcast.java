...
public final class JetHazelcast {
     ...
     */
    public static JetHazelcastInstance newHazelcastInstance(Config config) {
        return (JetHazelcastInstance) HazelcastInstanceFactory.INSTANCE.newHazelcastInstance(config);
    }
    ...
    public static JetHazelcastInstance newHazelcastInstance() {
        return (JetHazelcastInstance) HazelcastInstanceFactory.INSTANCE.newHazelcastInstance(null);
    }
    ...
    public static JetHazelcastInstance getHazelcastInstanceByName(String instanceName) {
        return (JetHazelcastInstance) HazelcastInstanceFactory.INSTANCE.getHazelcastInstance(instanceName);
    }
    ...
    public static JetHazelcastInstance getOrCreateHazelcastInstance(Config config) {
        return (JetHazelcastInstance) HazelcastInstanceFactory.INSTANCE.getOrCreateHazelcastInstance(config);
    }
