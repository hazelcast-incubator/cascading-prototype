...
public final class JetHazelcast {
    private JetHazelcast() {
    }
     ...
     *
     * @see #newHazelcastInstance(JetConfig)
     */
     ...
     */
    public static JetHazelcastInstance newHazelcastInstance(JetConfig config) {
        return (JetHazelcastInstance) HazelcastInstanceManager.newHazelcastInstance(config);
    }
     ...
     * @see #getHazelcastInstanceByName(String)
     */
    public static JetHazelcastInstance newHazelcastInstance() {
        return (JetHazelcastInstance) HazelcastInstanceManager.newHazelcastInstance(null);
    }
     ...
     * @see #shutdownAll()
     */
    public static JetHazelcastInstance getHazelcastInstanceByName(String instanceName) {
        return (JetHazelcastInstance) HazelcastInstanceManager.getHazelcastInstance(instanceName);
    }
     ...
     */
    public static JetHazelcastInstance getOrCreateHazelcastInstance(Config config) {
        return (JetHazelcastInstance) HazelcastInstanceManager.getOrCreateHazelcastInstance(config);
    }
