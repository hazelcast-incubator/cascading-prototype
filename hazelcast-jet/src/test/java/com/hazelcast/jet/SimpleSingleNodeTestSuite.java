...
public class SimpleSingleNodeTestSuite extends JetBaseTest {
    ...
    private void mixing(JetHazelcastInstance instance, String applicationName) throws Exception {
        ...
        try {
            ...
            for (int i = 0; i < 50; i++) {
                ...
                list.clear();
                assertEquals(targetMap1.size(), CNT);
                assertEquals(targetMap2.size(), CNT);
                assertEquals(targetMap3.size(), CNT);
                assertEquals(targetMap4.size(), CNT);
    ...
    private void counterTest(JetHazelcastInstance instance, String testName) throws Exception {
