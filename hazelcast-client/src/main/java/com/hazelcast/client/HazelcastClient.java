...
public final class HazelcastClient {
    private static final HazelcastClientManager HAZELCAST_CLIENT_MANAGER =
            HazelcastClientManager.HAZELCAST_CLIENT_MANAGER;

    private static final HazelcastClientFactory HAZELCAST_CLIENT_FACTORY =
            new HazelcastClientFactory() {
                @Override
    ...
    public static HazelcastInstance newHazelcastClient() {
        return HAZELCAST_CLIENT_MANAGER.newHazelcastClient(HAZELCAST_CLIENT_FACTORY);
    }

    public static HazelcastInstance newHazelcastClient(ClientConfig config) {
        return HAZELCAST_CLIENT_MANAGER.newHazelcastClient(config, HAZELCAST_CLIENT_FACTORY);
    }
    ...
    public static HazelcastInstance getHazelcastClientByName(String instanceName) {
        return HAZELCAST_CLIENT_MANAGER.getHazelcastClientByName(instanceName);
    }
