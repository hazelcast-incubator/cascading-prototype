...
public class IListStreamImpl<T> implements Stream<T> {
    ...
    private final JetHazelcastInstance jetHazelcastInstance;
    ...
    public IListStreamImpl(HazelcastInstance jetHazelcastInstance, String listName) {
        ...
        this.jetHazelcastInstance = (JetHazelcastInstance) jetHazelcastInstance;
    }
    ...
    private String execute() {
        ...
        try {
            ...
            this.jetHazelcastInstance.getConfig().addCustomServiceConfig(config);
            ...
            application = this.jetHazelcastInstance.getJetApplication(applicationName);
